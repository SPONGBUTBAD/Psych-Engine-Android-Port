...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
        ...
        var creditTxt:FlxText = new FlxText(4,healthBarBG.y + 20,0,("Port by skid pixel"), 24);
		...
		scoreTxt.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, C  , FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
